...
int main()
{
    ...
    do
    {
        ...
        cout<<"\nMENU"<<endl;
        cout<<"\n1. Create a record for new student"<<endl;
        cout<<"2. Search record of student"<<endl;
        cout<<"3. Display all records of student"<<endl;
        cout<<"4. Delete record of student"<<endl;
        cout<<"5. Modify record of student"<<endl;
        cout<<"6. Exit"<<endl;
...
//Write Details Of Student to File
...
void create_student()
{
    ...
    oFile.close();
    cout<<"\nThe record of Student has been created ";
    cin.ignore();
    cin.get();
}
...
void display_all()
{
    ...
    if(!inFile)
{
    cout<<"File could not be opened! Press any Key to exit this";
    cin.ignore();
    cin.get();
    return;
}
...
//Read Specific Record On Basis Of Roll Number
